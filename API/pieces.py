...
class Mouse(Piece):
    def __init__(self, color):
        ...
        self.targets = [(UP2, EMPTY | ENEMY), (DOWN2, EMPTY | ENEMY), (LEFT2, EMPTY | ENEMY), (RIGHT2, EMPTY | ENEMY), (UPRIGHT, EMPTY | ENEMY), (UPLEFT, EMPTY | ENEMY), (DOWNRIGHT, EMPTY | ENEMY), (DOWNLEFT, EMPTY | ENEMY)]
        self.deltas = []
